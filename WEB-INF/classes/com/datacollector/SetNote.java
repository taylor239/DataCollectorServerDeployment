 ...
 */
@WebServlet("/openDataCollection/setNote.json")
public class SetNote extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if(fromAnon)
		{
			result = myConnector.setNote(eventName, (String) inverseUserMap.get(userName), sessionName, admin, note, tagger);
		}
		else
		{
			result = myConnector.setNote(eventName, userName, sessionName, admin, note, tagger);
		}
