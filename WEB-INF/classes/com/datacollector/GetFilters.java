...
/**
 * Servlet implementation class GetFilters
 */
@WebServlet("/openDataCollection/Filters.json")
public class GetFilters extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		ArrayList filterMap = myConnector.getFilters(eventName, admin);
		Gson gson = new GsonBuilder().create();
		String output = gson.toJson(filterMap);
