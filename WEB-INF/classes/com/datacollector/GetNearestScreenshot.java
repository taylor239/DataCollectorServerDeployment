 ...
 */
@WebServlet(name="NearestScreenshot", urlPatterns= {"/openDataCollection/getClosestScreenshot.jpg"})
public class GetNearestScreenshot extends HttpServlet
{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		byte[] toWrite = myConnector.getScreenshot(username, sessionName, timestamp, eventName, admin);
