...
public class InstallScriptServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if(curDevice.equals("debvm") || curDevice.equals("debrpi"))
		{
			...
			+ "\nsudo add-apt-repository ppa:linuxuprising/java >> installOutput.txt" 
			+ "\nsudo apt update >> installOutput.txt" 
			+ "\nsudo apt install oracle-java16-installer >> installOutput.txt" 
			+ "\nif [[ $? > 0 ]]"
			+ "\nthen"
