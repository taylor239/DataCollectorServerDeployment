					...
					<td id="visRow">
						...
						<table id="searchTable">
							...
							<tr>
								...
								<td class="searchCol">
									<a class="expandPlus" onclick="toggleCol(this)">➕</a> <b>Email</b>
								</td>
								<td class="searchCol">
									<a class="expandPlus" onclick="toggleCol(this)">➕</a> <b>Name</b>
								</td>
							</tr>
							<tr>
								<td colspan="3">
...
<script>
	...
	async function downloadData()
	{
		...
		//if(needsUpdate)
		{
			...
			d3.json("getUserIdentification.json?event=" + eventName, async function(error, data)
				{
					try
					{
						var isDone = false;
						while(!isDone)
						{
							isDone = await persistDataAndWait("identitydata", data);
						}
					}
					catch(err)
					{
					...
					*/
					...
					d3.select("#title")
						.html(origTitle + "<br />Identity data: <b>" + downloadedSize + "</b> bytes downloaded.")
